...
#define C_MS_TO_SEC_MULTIPLIER 0.001f
...
CAPI i32 crandom();
CAPI i32 crandom_in_range(i32 min, i32 max);

CAPI f32 fcrandom();
CAPI f32 fcrandom_in_range(f32 min, f32 max);
...
CINLINE vec2 vec2_add(vec2 vector_0, vec2 vector_1)
{
    return (vec2){
...
CINLINE vec2 vec2_sub(vec2 vector_0, vec2 vector_1)
{
    return (vec2){
        vector_0.x - vector_1.x,
        vector_0.y - vector_1.y
...
CINLINE vec2 vec2_mul(vec2 vector_0, vec2 vector_1)
{
    return (vec2){
        vector_0.x * vector_1.x,
        vector_0.y * vector_1.y
...
CINLINE vec2 vec2_div(vec2 vector_0, vec2 vector_1)
{
    return (vec2){
        vector_0.x / vector_1.x,
        vector_0.y / vector_1.y
...
CINLINE f32 vec2_distance(vec2 vector_0, vec2 vector_1)
{
    vec2 d = (vec2){
        vector_0.x - vector_1.x,
        vector_0.y - vector_1.y
...
CINLINE vec3 vec3_add(vec3 vector_0, vec3 vector_1)
{
    return (vec3){
        vector_0.x + vector_1.x,
        vector_0.y + vector_1.y,
...
CINLINE vec3 vec3_sub(vec3 vector_0, vec3 vector_1)
{
    return (vec3){
        vector_0.x - vector_1.x,
        vector_0.y - vector_1.y,
...
CINLINE vec3 vec3_mul(vec3 vector_0, vec3 vector_1)
{
    return (vec3){
        vector_0.x * vector_1.x,
        vector_0.y * vector_1.y,
...
CINLINE vec3 vec3_mul_scalar(vec3 vector_0, f32 scalar)
{
    return (vec3){
        vector_0.x * scalar,
        vector_0.y * scalar,
...
CINLINE vec3 vec_div(vec3 vector_0, vec3 vector_1)
{
    return (vec3){
        vector_0.x / vector_1.x,
        vector_0.y / vector_1.y,
...
CINLINE f32 vec3_dot(vec3 vector_0, vec3 vector_1)
{
    f32 p = 0;
...
CINLINE vec3 vec3_cross(vec3 vector_0, vec3 vector_1)
{
    return (vec3){
...
CINLINE f32 vec3_distance(vec3 vector_0, vec3 vector_1)
{
    vec3 d = (vec3){
        vector_0.x - vector_1.x,
        vector_0.y - vector_1.y,
...
CINLINE vec4 vec4_add(vec4 vector_0, vec4 vector_1)
{
    vec4 result;
    for (u64 i = 0; i < 4; i++) {
...
CINLINE vec4 vec4_sub(vec4 vector_0, vec4 vector_1)
{
    vec4 result;
    for (u64 i = 0; i < 4; i++) {
        result.elements[i] = vector_0.elements[i] - vector_1.elements[i];
...
CINLINE vec4 vec4_muls(vec4 vector_0, vec4 vector_1)
{
    vec4 result;
    for (u64 i = 0; i < 4; i++) {
        result.elements[i] = vector_0.elements[i] * vector_1.elements[i];
...
CINLINE vec4 vec4_div(vec4 vector_0, vec4 vector_1)
{
    vec4 result;
    for (u64 i = 0; i < 4; i++) {
        result.elements[i] = vector_0.elements[i] / vector_1.elements[i];
...
CINLINE mat4 mat4_mul(mat4 matrix_0, mat4 matrix_1)
{
...
CINLINE quat quat_slerp(quat q_0, quat q_1, f32 percentage)
{
    ...
    f32 theta_0 = cacos(dot);          
    f32 theta = theta_0 * percentage;  
    f32 sin_theta = csin(theta);           
    f32 sin_theta_0 = csin(theta_0);       

    f32 s0 = ccos(theta) - dot * sin_theta / sin_theta_0;
